    ...
    <Container headerShown={false}>
      <ScrollView contentContainerStyle={{ flexGrow: 1, backgroundColor: "white" }} keyboardShouldPersistTaps="handled">
        <Content>
          ...
          <Gap size={24} />
          <View>
            <Text bold fontSize={24}>Login</Text>
            <Gap size={12} />
            <Text>Your friends are waiting - Log in with email or Google to join the conversation.</Text>
          </View>
          <Gap size={24} />
          <TextInput
            placeholder="Email ID"
            leftIcon={<Entypo name="email" size={20} color={Colors.Black.Icon} />}
          />
          <Gap size={18} />
          <Button
            label={"Login"}
          ...
          <Gap size={16} />
          <Text medium fontSize={16} style={{ alignSelf: 'center' }} color={Colors.White.Dark}>OR</Text>
          <Gap size={16} />
          <Button
